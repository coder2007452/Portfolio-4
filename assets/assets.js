...
export const serviceData = [
    { icon: assets.web_icon, title: 'Frontend', description: 'Frontend is the process of building, programming...', link: '' },
    { icon: assets.mobile_icon, title: 'Backend', description: 'Backend development involves creating control files for websites...', link: '' },
]

export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JAVA, React Js, Next Js, MERN, C++, Python' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'Bsc in Computer Science' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built more than 40 projects' }
];
